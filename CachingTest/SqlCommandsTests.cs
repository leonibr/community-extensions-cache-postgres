...
public class SqlCommandsTests
{
    ...
    [Fact]
    public void SqlCommands_WithSpecialCharactersInNames_HandlesCorrectly()
    {
        // Arrange
        var sqlCommands = new SqlCommands("my-schema", "my-table");

        // Act
        var createSql = sqlCommands.CreateSchemaAndTableSql;
        var getSql = sqlCommands.GetCacheItemSql;

        // Assert
        Assert.Contains("\"my-schema\"", createSql);
        Assert.Contains("\"my-table\"", createSql);
        Assert.Contains("\"my-schema\".\"my-table\"", getSql);
    }

    [Fact]
    public void SqlCommands_WithEmptyNames_HandlesCorrectly()
    {
        // Arrange
        ...
        // Assert
        Assert.Contains("\"\"", createSql);
        Assert.Contains("\"\".\"\"", getSql);
    }

    [Fact]
    public void SqlCommands_WithNullNames_HandlesCorrectly()
    {
        // Arrange
        var sqlCommands = new SqlCommands(null!, null!);
